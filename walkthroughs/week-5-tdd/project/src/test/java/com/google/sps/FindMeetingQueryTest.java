...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optional830_9() {
    // 2. Have each person have different events. Add an optional attendee C who has an all-day event. The same three time slots should be returned as when C was not invited.
    //
    // Events  :       |--A--|     |--B--|
    //                       |-Copt| 
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalBNotEnoughRoom() {
    // 3. Add an optional attendee B who has an event between 8:30 and 8:45. The optional attendee should be ignored since considering their schedule would result in a time slot smaller than the requested time.
    //
    // Events  : |--A--|--B--|----A----|
    // Day     : |---------------------|
    // Options :       |-----|
